    ...
    constructor() {
        ...
        this.translations = window.translations || {
            de: {
                ...
                'caseStudies.reference.quote': 'Die systematische Bearbeitung von Overspending ist ein starker Hebel für unsere Profitabilität. Mit qado haben wir eine Lösung gefunden, die uns hilft, Einsparungen transparent zu machen und Vertragsstrafen automatisch zu verfolgen.',
                ...
                'caseStudies.solution.p1': 'Techem implementierte qado – eine KI-gestützte Plattform für Overspending-Detektion und Vertragsintelligenz. qado wurde darauf konfiguriert, bestehende Lieferantenverträge und relevante Dokumente einzulesen und automatisch entscheidende Vertragsbedingungen zu extrahieren.',
                ...
                'caseStudies.solution.li1': '4 % Overspending, weil Indexanpassungen in einer Pilotkategorie nicht umgesetzt wurden.',
                'caseStudies.solution.li2': 'Nicht eingeforderte Vertragsstrafen bei 10 % des analysierten Einkaufsvolumens aufgrund fehlender ERP-Automatisierung.',
                'caseStudies.solution.li3': 'Veraltete Preisstammdaten im ERP, die unnötige manuelle Nacharbeit verursachten.',
                'caseStudies.solution.p3': 'Zusätzlich ermöglicht qado:',
                'caseStudies.solution.li4': 'Verhandlungsalerts mit externen Trends, Lieferantenvergleich und Historie – reduziert Recherchezeit um 85 %.',
                'caseStudies.solution.li5': 'Schnelles Benchmarking von Vertragskonditionen und Angeboten – spart 80 % Zeit und erhöht die Ergebnisqualität.',
                'caseStudies.solution.li6': 'Verträge inklusive Ergänzungen in Minuten statt Stunden zu durchsuchen und zu verstehen.',
                'caseStudies.solution.li7': 'Risiken zu reduzieren, indem Verträge mit Templates, anderen Vereinbarungen und Richtlinien verglichen werden.',
                ...
                'caseStudies.impact.li2': 'Teams in Einkauf und Supply Chain haben sofortige Transparenz über Verträge, Konditionen und Lieferantenangebote.',
                'caseStudies.impact.li3': 'Manuelle Arbeit für Indexanpassungen, Rabatte und Vertragsstrafen entfällt.',
                'caseStudies.impact.li4': 'Durchsetzung ausgehandelter Konditionen reduziert Value Leakage und steigert erzielte Einsparungen.',
            ...
            en: {
                ...
                'caseStudies.reference.quote': 'The systematic handling of overspending is a powerful lever for our profitability. With qado, we found a solution that helps us create transparency on savings and automatically track contractual penalties.',
                'caseStudies.reference.name': 'Klaus Linderich',
                'caseStudies.reference.role': 'Head of Procurement and Supply Chain',
                'caseStudies.challenge.title': 'The challenge',
                'caseStudies.challenge.p1': 'Techem is a leading service provider for smart and sustainable buildings. The company covers energy management and resource conservation, healthy living, and process efficiency in properties.',
                'caseStudies.challenge.p2': 'Techem\'s procurement team manages a large portfolio of supplier and service contracts including critical clauses on pricing indexes, rebates, service level penalties, and delivery obligations. The complexity and tight timelines in supply chain execution made it impossible to monitor every clause and penalty.',
                'caseStudies.challenge.p3': 'Manual tracking of index adjustments, rebates, and penalties is resource-intensive and error-prone. ERP systems cannot capture every negotiated term—especially for indirect spend—so overspend went unnoticed.',
                'caseStudies.solution.title': 'The solution',
                'caseStudies.solution.p1': 'Techem adopted qado, an AI-driven overspend detection and contract intelligence platform. qado was configured to ingest existing supplier contracts and documents and automatically extract key clauses.',
                'caseStudies.solution.p2': 'qado\'s Overspend Agents were deployed to identify where contractual commitments were not enforced in purchase orders and invoices. They uncovered:',
                'caseStudies.solution.li1': '4% overspend because index adjustment clauses were not applied in one pilot category.',
                'caseStudies.solution.li2': 'Unclaimed late-delivery penalties across 10% of the analyzed spend due to ERP limitations.',
                'caseStudies.solution.li3': 'Outdated price records in ERP systems, triggering unnecessary manual rework for purchase orders and supplier interactions.',
                'caseStudies.solution.p3': 'Beyond that, qado enables teams to:',
                'caseStudies.solution.li4': 'Receive alerts when renegotiations should be considered, complete with negotiation levers, external trends, benchmarks, and supplier history—cutting research time by 85%.',
                'caseStudies.solution.li5': 'Quickly benchmark negotiated contract terms against each other and new supplier quotes, saving 80% of time while improving outcomes.',
                'caseStudies.solution.li6': 'Search and understand any contract—including amendments and appendices—in minutes instead of hours spent combing through PDFs.',
                'caseStudies.solution.li7': 'Reduce risk by comparing contracts against templates, other agreements, and legal guidelines.',
                'caseStudies.impact.title': 'The impact',
                'caseStudies.impact.p1': 'With qado in place, Techem achieved fast, high-impact results:',
                'caseStudies.impact.li1': 'Overspending and compliance gaps surface within hours instead of months.',
                'caseStudies.impact.li2': 'Procurement and supply chain staff gain instant visibility into contracts, critical terms, and supplier quotes.',
                'caseStudies.impact.li3': 'Manual work on index adjustments, rebates, and penalties is eliminated, freeing staff capacity.',
                'caseStudies.impact.li4': 'Enforcement of negotiated terms reduces value leakage and increases realized savings.',
                'caseStudies.impact.li5': 'Strategic decisions and negotiations are now driven by facts and data.',
                'caseStudies.next.title': 'Next steps',
                'caseStudies.next.p1': 'Together, Techem and qado continue to expand the program:',
                ...
                'caseStudies.callout.title': 'Confident execution of complex contract obligations',
                'caseStudies.callout.body': 'A major problem in purchasing is the correct implementation of complex contractual terms and conditions. It is often difficult to keep track of every index price, every discount scale, and every service level clause. qado\'s AI helps us create transparency and gives us the assurance that no negotiated values are lost and that price reductions and contractual penalties are claimed automatically.',
