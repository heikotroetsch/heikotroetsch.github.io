    ...
    constructor() {
        ...
        this.translations = window.translations || {
            de: {
                ...
                'notification.title3': 'Rechnungsfehler identifiziert',
                ...
                'reference.quote1': 'Ein großes Problem im Einkauf ist die korrekte Umsetzung komplexer, vertraglicher Konditionen. Es ist oftmals schwierig, jeden Indexpreis, jede Rabattstaffel und jede Service-Level-Klausel immer im Blick zu behalten. <strong>qados KI</strong> hilft uns Transparenz zu schaffen und <strong>gibt uns Sicherheit, dass keine verhandelten Werte verloren gehen</strong> und die Einforderung von Preissenkungen und Vertragsstrafen automatisiert erfolgt.',
                'reference.name2': 'Thomas Klofac',
                'reference.role2': 'Ehem. President Consumer Healthcare',
                'reference.quote2': '<strong>Viele Verhandlungserfolge bleiben auf dem Weg in die GuV auf der Strecke</strong>. Komplexe Klauseln lassen sich in ERP-Systemen kaum abbilden, das erzeugt trügerische Sicherheit. Mit qado wird Profitabilität einfach gesteigert indem bereits verhandelte Abmachungen tatsächlich operativ umgesetzt werden.',
                
                // Case Studies
                'caseStudies.kicker': 'Case Study',
                'caseStudies.title': 'Techem & qado: Contract Intelligence in Aktion',
                'caseStudies.summary': 'Wie Techem Overspending aufdeckt, Vertragsklauseln automatisiert durchsetzt und Verhandlungsteams mit Fakten stärkt.',
                'caseStudies.reference.quote': 'Ein großes Problem im Einkauf ist die korrekte Umsetzung komplexer, vertraglicher Konditionen. Es ist oftmals schwierig, jeden Indexpreis, jede Rabattstaffel und jede Service-Level-Klausel immer im Blick zu behalten. <strong>qado\'s KI</strong> hilft uns Transparenz zu schaffen und <strong>gibt uns Sicherheit, dass keine verhandelten Werte verloren gehen</strong> und die Einforderung von Preissenkungen und Vertragsstrafen automatisiert erfolgt.',
                'caseStudies.reference.name': 'Klaus Linderich',
                'caseStudies.reference.role': 'Head of Procurement and Supplier Quality',
                'caseStudies.challenge.title': 'Die Herausforderung',
                'caseStudies.challenge.p1': 'Techem ist ein führender Dienstleister für smarte und nachhaltige Gebäude, dessen Leistungen Energie- und Ressourcenmanagement, gesundes Wohnen sowie Prozesseffizienz in Immobilien abdecken.',
                'caseStudies.challenge.p2': 'Das Einkaufsteam verwaltet ein umfangreiches Portfolio an Lieferanten- und Dienstleistungsverträgen mit kritischen Klauseln zu Preisindizes, Rabatten, Service-Level-Strafen und Lieferverpflichtungen. Die <strong>Komplexität</strong> und der <strong>Zeitdruck</strong> in der Ausführung machten es jedoch unmöglich, jede <strong>Klausel und Vertragsstrafe</strong> nachzuverfolgen.',
                'caseStudies.challenge.p3': 'Manuelle Nachverfolgung von Indexanpassungen, Rabatten und Vertragsstrafen ist aufwendig und fehleranfällig. ERP-Systeme bilden zudem nicht alle ausgehandelten Bedingungen ab – besonders im indirekten Einkauf – sodass Overspending unbemerkt blieb.',
                'caseStudies.solution.title': 'Die Lösung',
                'caseStudies.solution.p1': 'Techem implementierte qado – eine KI-gestützte Plattform für Overspending-Detektion und Vertragsintelligenz. qado wurde darauf konfiguriert, bestehende Lieferantenverträge und relevante Dokumente einzulesen und automatisch zentrale Vertragsbedingungen wie Indexanpassungsklauseln, Kickbacks, Lieferbedingungen und Vertragsstrafen auszulesen.',
                'caseStudies.solution.p2': 'Die Overspend Agents von qado wurden eingesetzt, um Verpflichtungen in Verträgen mit Bestellungen und Rechnungen abzugleichen. Sie identifizierten unter anderem:',
                'caseStudies.solution.li1': '<strong>4 % Overspending</strong>, weil Indexanpassungen in einer Pilotkategorie nicht umgesetzt wurden.',
                'caseStudies.solution.li2': '<strong>Nicht eingeforderte Vertragsstrafen</strong> bei 10 % des analysierten Einkaufsvolumens aufgrund fehlender ERP-Automatisierung.',
                'caseStudies.solution.li3': '<strong>Veraltete Preisstammdaten</strong> im ERP, die unnötige manuelle Nacharbeit verursachten.',
                'caseStudies.solution.p3': 'Zusätzlich ermöglicht qado:',
                'caseStudies.solution.li4': '<strong>Benachrichtigungen, wann Nachverhandlungen sinnvoll sind</strong>, inklusive externer Trends, Lieferantenvergleich und Historie – reduziert Recherchezeit um 85 %.',
                'caseStudies.solution.li5': 'Schnelles <strong>Benchmarking von Vertragskonditionen und Angeboten</strong> – spart 80 % Zeit und erhöht die Ergebnisqualität.',
                'caseStudies.solution.li6': 'Verträge inklusive Ergänzungen <strong>in Minuten statt Stunden</strong> zu durchsuchen und zu verstehen.',
                'caseStudies.solution.li7': '<strong>Risiken zu senken</strong>, indem Verträge mit Templates, anderen Vereinbarungen und Richtlinien verglichen werden.',
                'caseStudies.impact.title': 'Die Auswirkungen',
                'caseStudies.impact.p1': 'Mit qado erzielte Techem schnell spürbare Ergebnisse:',
                'caseStudies.impact.li1': 'Overspending und Compliance-Lücken werden in Stunden statt Monaten sichtbar.',
                'caseStudies.impact.li2': 'Teams in Einkauf und Supply Chain haben sofortige Transparenz: Sie finden jede Vereinbarung auf Anhieb, verstehen kritische Klauseln, vergleichen neue Lieferantenangebote und stellen sicher, dass verhandelte Bedingungen eingehalten werden.',
                'caseStudies.impact.li3': 'Manuelle Arbeit für Indexanpassungen, Rabatte und Vertragsstrafen entfällt.',
                'caseStudies.impact.li4': 'Bessere Durchsetzung ausgehandelter Konditionen reduziert Wertverluste und steigert erzielte Einsparungen.',
                'caseStudies.impact.li5': 'Strategische Entscheidungen und Verhandlungen basieren auf validen Daten.',
                ...
                'bento.execution.table.subtitle': 'Vertaglich zugesicherte Indexpreise und deren Kostenauswirkungen',
                ...
                'bento.automation.point1': 'Lassen Sie KI-Agenten Bestellbestätigungen und andere operative Tätigkeiten übernehmen - leistungsstark dank vollem Vertragswissen',
                ...
                'bento.notification.title': 'Die Inputkosten von Apex für Federn sind seit dem letztem Jahr um <strong>16%</strong> gesunken. Sie können vor dem <strong>10. November</strong> neu verhandeln.',
                ...
                'waitinglist.benefit1': 'Als AI-Innovator im Einkauf positionieren',
                ...
                'waitinglist.benefit4': 'Die KI-Einkaufsplattform der Zukunft mit eigenen Erfahrungen mitgestalten',
                ...
                'faq.what_is_qado.bullet1': '<strong>Prüft automatisch</strong> Bestellungen, Rechnungen und Wareneingänge gegen Vertragskonditionen',
                'faq.what_is_qado.bullet2': '<strong>Erkennt Abweichungen</strong> in Echtzeit (falsche Preise, SLA-Verletzungen, ungenutzte Boni)',
                'faq.what_is_qado.bullet3': '<strong>Dokumentiert und fordert zurück</strong> bei Bedarf automatisch',
                'faq.what_is_qado.bullet4': '<strong>Integriert sich nahtlos</strong> in Ihr ERP (SAP, Oracle, MS Dynamics etc.)',
                ...
                'faq.how_works.phase1.bullet1': 'Wir analysieren 1–3 Jahre historischer Daten (Verträge, Bestellungen, Rechnungen)',
                ...
                'faq.difference.bullet1': '<strong>KI-gestützte Vertragsanalyse:</strong> Versteht komplexe Vertragskonditionen automatisch',
                'faq.difference.bullet2': '<strong>Echtzeit-Überwachung:</strong> Erkennt Abweichungen sofort, nicht erst bei der Rechnungsprüfung',
                'faq.difference.bullet3': '<strong>Nahtlose Integration:</strong> Funktioniert mit bestehenden ERP-Systemen',
                'faq.difference.bullet4': '<strong>Messbare Ergebnisse:</strong> 2-4% Kosteneinsparungen der Beschaffungskosten',
                'faq.difference.bullet5': '<strong>Vollständige Transparenz:</strong> Ermöglicht Folgeverhandlungen auf Basis von Fakten',
                ...
                'datenschutz.general.responsible.company': 'qado GmbH i.G.<br>Schraudolphstraße 42<br>80799 München<br><br>Handelsregister: i.G.<br>Registergericht: Amtsgericht München<br><br>Vertreten durch: Heiko Trötsch, Nicolas Pardon, Patrick Gundlach<br><br>E-Mail: <a href="mailto:support@qado.ai">support@qado.ai</a><br>Website: <a href="https://qado.ai">qado.ai</a>',
                ...
                'impressum.tmg.content': 'qado GmbH i.G.<br>Schraudolphstraße 42<br>80799 München',
                'impressum.contact.title': 'Kontakt',
                'impressum.contact.content': 'Telefon: [Telefonnummer]<br>E-Mail: <a href="mailto:support@qado.ai">support@qado.ai</a>',
                
                // Additional Impressum German translations
                'impressum.represented.title': 'Vertreten durch',
                'impressum.represented.content': 'Heiko Trötsch, Nicolas Pardon, Patrick Gundlach',
                ...
                'impressum.vat.content': 'Umsatzsteuer-Identifikationsnummer gemäß § 27 a Umsatzsteuergesetz:<br>i.G.',
                'impressum.insurance.title': 'Angaben zur Berufshaftpflichtversicherung',
                'impressum.insurance.insurer': 'Name und Sitz des Versicherers:',
                'impressum.insurance.coverage': 'Geltungsraum der Versicherung:',
                'impressum.dispute_resolution.title': 'Verbraucherstreitbeilegung/Universalschlichtungsstelle',
                'impressum.dispute_resolution.content': 'Wir sind nicht bereit oder verpflichtet, an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teilzunehmen.',
            ...
            en: {
                ...
                'notification.title3': 'Invoice error identified',
                ...
                // Case Studies
                'caseStudies.kicker': 'Case Study',
                'caseStudies.title': 'Techem & qado: Contract intelligence in action',
                'caseStudies.summary': 'How Techem surfaces overspending, enforces contract clauses automatically, and equips negotiation teams with facts.',
                'caseStudies.reference.quote': "A major problem in purchasing is the correct implementation of complex contractual terms and conditions. It is often difficult to keep track of every index price, every discount scale, and every service level clause. <strong>qado's AI</strong> helps us create transparency and gives us the assurance that <strong>no negotiated values are lost</strong> and that <strong>price reductions and contractual penalties are claimed automatically</strong>.",
                'caseStudies.reference.name': 'Klaus Linderich',
                'caseStudies.reference.role': 'Head of Procurement and Supply Chain',
                'caseStudies.challenge.title': 'The Challenge',
                'caseStudies.challenge.p1': 'Techem is a leading service provider for smart and sustainable buildings. The company\'s services cover the topics of energy management and resource conservation, healthy living and process efficiency in properties.',
                'caseStudies.challenge.p2': 'Techem\u2019s procurement team is managing a large portfolio of supplier and service contracts. These contracts contain critical clauses around pricing indexes, rebates, service level penalties, and delivery obligations. But the <strong>sheer complexity</strong> and <strong>tight time constraints</strong> in supply chain execution made it <strong>impossible to track the application of every clause and penalty.</strong>',
                'caseStudies.challenge.p3': 'Manual tracking of index adjustments, rebates, and enforcement of penalties takes excessive effort and carries error risk. Additionally, ERP systems can not reflect every negotiated term, especially for indirect spends, meaning Techem incurred overspend without realizing it.',
                'caseStudies.solution.title': 'The Solution',
                'caseStudies.solution.p1': 'Techem adopted qado, an <strong>AI-driven overspend detection and contract intelligence</strong> platform. qado was configured to ingest existing supplier contracts and relevant documents. It automatically extracts key contract terms: index-adjustment clauses, kickbacks, delivery terms, and penalty provisions.',
                'caseStudies.solution.p2': 'qado\u2019s \u201cOverspend Agents\u201d were deployed to identify where commitments in contracts were not being enforced in purchase orders and invoices. Specifically, they:',
                'caseStudies.solution.li1': 'Detected an <strong>overspend of 4%</strong> due to index adjustment clauses that had not been enforced in one of the pilot categories.',
                'caseStudies.solution.li2': 'Unclaimed <strong>late delivery penalties</strong> were identified across 10% of Techem\u2019s analyzed spend, due to limitations in the ERP system\u2019s automated tracking.',
                'caseStudies.solution.li3': 'Discovered that <strong>ERP systems had outdated price records</strong>, leading to unnecessary manual rework in correcting purchase orders and supplier interaction.',
                'caseStudies.solution.p3': 'Besides that, qado\u2019s intelligence platform allows to:',
                'caseStudies.solution.li4': '<strong>Receive alerts when re-negotiations</strong> should be considered and get a report of <strong>suitable negotiation levers</strong>, including external trends, comparison against other suppliers and supplier history \u2013 cutting time for negotiation research by 85%.',
                'caseStudies.solution.li5': 'Quickly <strong>benchmark negotiated contract terms</strong> against each other and quotes from new suppliers, saving 80% of time and improving result quality.',
                'caseStudies.solution.li6': '<strong>Search through and understand any contract</strong>, including all its amendment and appendices in minutes rather than hours of time trying to find and read PDFs.',
                'caseStudies.solution.li7': '<strong>Reduce risk</strong> by comparing contracts against templates, other agreements and legal guidelines.',
                'caseStudies.impact.title': 'The Impact',
                'caseStudies.impact.p1': 'With qado in place, Techem achieved fast-moving, high-impact results:',
                'caseStudies.impact.li1': 'Overspend and compliance gaps surface in a matter of hours rather than months.',
                'caseStudies.impact.li2': 'Procurement & Supply Chain staff gained visibility: they can instantly find any contract, understand its critical terms, compare new supplier quotes, and ensure negotiated terms are being respected.',
                'caseStudies.impact.li3': 'Manual work tracking index adjustments, rebates, and penalties was eliminated, freeing up large amounts of staff time.',
                'caseStudies.impact.li4': 'Techem improved enforcement of negotiated contract terms, reducing value leakage and increasing realized savings.',
                'caseStudies.impact.li5': 'Strategic decision making and supplier negotiations are now better enabled by facts and data',
                ...
                'waitinglist.benefit1': 'Position yourself as an AI innovator in procurement',
                'waitinglist.benefit2': 'Reduce procurement spend by 2%-4% without renegotiating',
                'waitinglist.benefit3': 'Have answers to contract questions ready in seconds',
                'waitinglist.benefit4': 'Co-create the AI procurement platform of the future with your own experience',
                'waitinglist.email.placeholder': 'your.email@company.com',
                'waitinglist.button': 'Secure spot',
                ...
                'faq.what_is_qado.bullet1': '<strong>Automatically checks</strong> orders, invoices and goods receipts against contract terms',
                'faq.what_is_qado.bullet2': '<strong>Detects deviations</strong> in real-time (incorrect prices, SLA violations, unused bonuses)',
                'faq.what_is_qado.bullet3': '<strong>Documents and automatically reclaims</strong> when needed',
                'faq.what_is_qado.bullet4': '<strong>Seamlessly integrates</strong> into your ERP (SAP, Oracle, MS Dynamics etc.)',
                ...
                'faq.difference.bullet1': '<strong>AI-powered contract analysis:</strong> Automatically understands complex contract terms',
                'faq.difference.bullet2': '<strong>Real-time monitoring:</strong> Detects deviations immediately, not just during invoice checking',
                'faq.difference.bullet3': '<strong>Seamless integration:</strong> Works with existing ERP systems',
                'faq.difference.bullet4': '<strong>Measurable results:</strong> 2-4% cost savings of procurement costs',
                'faq.difference.bullet5': '<strong>Complete transparency:</strong> Enables follow-up negotiations based on facts',
                ...
                'datenschutz.general.responsible.company': 'qado GmbH i.G.<br>Schraudolphstraße 42<br>80799 München<br><br>Commercial Register: i.G.<br>Registration Court: Amtsgericht München<br><br>Represented by: Heiko Trötsch, Nicolas Pardon, Patrick Gundlach<br><br>E-Mail: <a href="mailto:support@qado.ai">support@qado.ai</a><br>Website: <a href="https://qado.ai">qado.ai</a>',
                ...
                'impressum.contact.content': 'Phone: [Phone number]<br>E-Mail: <a href="mailto:support@qado.ai">support@qado.ai</a>',
                ...
                'impressum.vat.content': 'VAT identification number according to § 27 a VAT Act:<br>i.G.',
                'impressum.insurance.title': 'Information on professional liability insurance',
                'impressum.insurance.insurer': 'Name and registered office of the insurer:',
                'impressum.insurance.coverage': 'Scope of insurance:',
                'impressum.dispute_resolution.title': 'Consumer dispute resolution/Universal arbitration board',
                'impressum.dispute_resolution.content': 'We are not willing or obliged to participate in dispute resolution proceedings before a consumer arbitration board.',
